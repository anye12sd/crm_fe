    ...
    export default {
        ...
        methods: {
            ...
            saveForm() {
                ...
                if(this.form.friendEmail){
                    if (!this.$regTest.emailTest(this.form.friendEmail)) {
                        this.$message.error("请输入正确的邮箱")
                        return -1
                    }
                }
                if(this.form.friendPhone){
                    if (!this.$regTest.phoneTest(this.form.friendPhone)) {
                        this.$message.error("请输入正确的电话")
                        return -1
                    }
                }
                if(this.form.friendMobilePhone){
                    console.log(this.form.friendMobilePhone)
                    if (!this.$regTest.mobileTest(this.form.friendMobilePhone)) {
                        this.$message.error("请输入正确的移动电话")
                        return -1
                    }
                }
                if(this.form.friendFax){
                    if (!this.$regTest.phoneTest(this.form.friendFax)) {
