        ...
        methods: {
            ...
            saveForm() {
                ...
                if(this.form.contactEmail){
                    if (!this.$regTest.emailTest(this.form.contactEmail)) {
                        this.$message.error("请输入正确的邮箱")
                        return -1
                    }
                }
                if(this.form.contactOfficePhone){
                    if (!this.$regTest.phoneTest(this.form.contactOfficePhone)) {
                        this.$message.error("请输入正确的办公电话")
                        return -1
                    }
                }
                if(this.form.contactHomePhone){
                    if (!this.$regTest.phoneTest(this.form.contactHomePhone)) {
                        this.$message.error("请输入正确的家庭电话")
                        return -1
                    }
                }
                if(this.form.contactFax){
                    if (!this.$regTest.phoneTest(this.form.contactFax)) {
                        this.$message.error("请输入正确的传真")
                        return -1
                    }
                }
                if(this.form.contactHomePhone){
                    if (!this.$regTest.mobileTest(this.form.contactHomePhone)) {
