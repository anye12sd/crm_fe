...
<script>
    ...
    const columns = [
        ...
        },
        {
            ...
            key: 'returnCode',
            sorter: (a, b) => a.returnCode > b.returnCode ? 1 : -1
        },
        {
            title: '订单状态',
    ...
    const headerContentSelect = [
        {label: 'dayReturn', name: '今日退货单', stopFlag: '1'},
        {label: 'weekReturn', name: '本周退货单', stopFlag: '1'},
        {label: 'monthReturn', name: '本月退货单', stopFlag: '2'},
    ]
    const queryColumns = [
        {
            title: '标题',
    ...
    export default {
        ...
        data() {
            return {
                ...
                operateFixed: true,
                buttons: ['view'],
                headerContent: ['displaylist', 'select', 'excel', 'statistics', 'search', 'add', 'customerCollect', 'partnerCollect'],
                myQuery: '我的查询',
        ...
        methods: {
            ...
            getShowList(arr) {
                this.columns = []
                let k = 0
                this.checkedList = arr || ['date', 'returnCode']
