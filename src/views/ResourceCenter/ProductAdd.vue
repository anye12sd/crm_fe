    ...
    export default {
        ...
        methods: {
            ...
            saveForm() {
                ...
                if(this.form.prodListPrice){
                    if (!this.$regTest.priceTest(this.form.prodListPrice)) {
                        this.$message.error("请输入正确的定价")
                        return -1
                    }
                }
                if(this.form.prodUnitCost){
                    if (!this.$regTest.priceTest(this.form.prodUnitCost)) {
                        this.$message.error("请输入正确的单位成本")
                        return -1
                    }
                }
                if(this.form.prodPurchasePrice){
                    if (!this.$regTest.priceTest(this.form.prodPurchasePrice)) {
                        this.$message.error("请输入正确的采购参考价")
                        return -1
                    }
                }
