...
<script>
    const tableData = [
        { DiscussGroupName: '【榜样】的力量是无穷的！', code: 201, publisher: '中文', theme: 'O', customerName: '管理机构', telephone: '', Email: '', address: '', link: '/TempDirectory/DiscussDetail' },
        { DiscussGroupName: '【榜样】的力量是无穷的！', code: 120, publisher: '中文2', theme: 'OA', customerName: '总公司', telephone: '', Email: '', address: '', link: '/TempDirectory/DiscussDetail' },
        { DiscussGroupName: '【榜样】的力量是无穷的！', code: 430, publisher: '中文3', theme: 'OAOA', customerName: '名称1', telephone: '', Email: '', address: '', link: '/TempDirectory/DiscussDetail' },
        { DiscussGroupName: '【榜样】的力量是无穷的！', code: 404, publisher: '中文4', theme: 'O', customerName: '名称1', telephone: '', Email: '', address: '', link: '/TempDirectory/DiscussDetail' },
        { DiscussGroupName: '【榜样】的力量是无穷的！', code: 111, publisher: '中文5', theme: 'OA', customerName: '名称1', telephone: '', Email: '', address: '', link: '/TempDirectory/DiscussDetail' },
        { DiscussGroupName: '【榜样】的力量是无穷的！', code: 65, publisher: '中文6', theme: 'OAOA', customerName: '名称1', telephone: '', Email: '', address: '', link: '/TempDirectory/DiscussDetail' },
        { DiscussGroupName: '【榜样】的力量是无穷的！', code: 7, publisher: '中文7', theme: 'A', customerName: '名称1', telephone: '', Email: '', address: '', link: '/TempDirectory/DiscussDetail' }
    ];
    const columns = [
        {
            title: '讨论组名称',
            dataIndex: 'DiscussGroupName',
            key: 'DiscussGroupName',
            sorter: (a, b) => a.DiscussGroupName > b.DiscussGroupName ? 1 : -1
        },
        {
            title: '发表人',
            dataIndex: 'publisher',
        ...
        },
        {
            ...
            key: 'publishTime',
            sorter: (a, b) => a.publishTime > b.publishTime ? 1 : -1
        },
        {
            title: '修改时间',
        ...
        {
            title: '屏蔽时间',
            dataIndex: 'shieldTime',
            key: 'shieldTime',
            sorter: (a, b) => a.shieldTime > b.shieldTime ? 1 : -1
        },
        {
            title: '回复次数',
            dataIndex: 'replyTime',
            key: 'replyTime',
            sorter: (a, b) => a.replyTime > b.replyTime ? 1 : -1
        }
    ];
    ...
    export default {
        ...
        data() {
            return {
                ...
                buttons: ['view'],
                headerContent: ['displaylist', 'select', 'excel', 'statistics', 'search', 'add', 'clew'],
