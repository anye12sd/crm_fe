...
<template>
  <a-layout class="main-layout">
    ...
    ></description-item>
    <category-tabs :usedTabs="usedTabs" :usedTabsColumns="usedTabsColumns"></category-tabs>
  </a-layout>
</template>
...
const descriptionColumn = // 对象按顺序排列的数组
        [
          { name: 'partnerCode', span: 2 },
          { name: 'partnerMnemonic', span: 1 },
          { name: 'partnerName', span: 2 },
          ...
          { name: 'recognizeNumber', span: 1 },
          { name: 'recognizeWay', span: 2 },
          { name: 'remark', span: 3 },
        ]
