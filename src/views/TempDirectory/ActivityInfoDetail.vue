...
const usedTabs = ['相关任务', '相关员工', '工作记录', '问题讨论', '销售机会', '销售订单', '客户', '客户联系人', '合作伙伴', '伙伴联系人', '供应商', '供应商联系人', '已收邮件', '已发邮件', '附件'];
const usedTabsColumns = {
  ...
  customerColumns: {
    ...
    show: true,
    columns: [
      {title: '编码', dataIndex: 'clientCode', key: 'clientCode'},
