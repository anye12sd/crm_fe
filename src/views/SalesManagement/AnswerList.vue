...
<script>
    const tableData = [
        { status: '', departmentName: 201, startDate: '中文', endDate: 'O', theme: '管理机构', telephone: '', Email: '', address: '', link: '/SalesManagement/SalesChanceDetail' },
        { status: '', departmentName: 120, startDate: '中文2', endDate: 'OA', theme: '总公司', telephone: '', Email: '', address: '', link: '/SalesManagement/SalesChanceDetail' },
        { status: '', departmentName: 430, startDate: '中文3', endDate: 'OAOA', theme: '名称1', telephone: '', Email: '', address: '', link: '/SalesManagement/SalesChanceDetail' },
        { status: '', departmentName: 404, startDate: '中文4', endDate: 'O', theme: '名称1', telephone: '', Email: '', address: '', link: '/SalesManagement/SalesChanceDetail' },
        { status: '', departmentName: 111, startDate: '中文5', endDate: 'OA', theme: '名称1', telephone: '', Email: '', address: '', link: '/SalesManagement/SalesChanceDetail' },
        { status: '', departmentName: 65, startDate: '中文6', endDate: 'OAOA', theme: '名称1', telephone: '', Email: '', address: '', link: '/SalesManagement/SalesChanceDetail' },
        { status: '', departmentName: 7, startDate: '中文7', endDate: 'A', theme: '名称1', telephone: '', Email: '', address: '', link: '/SalesManagement/SalesChanceDetail' }
    ];
    const columns = [
        {
            title: '提交时间',
    ...
    export default {
        ...
        data() {
            return {
                ...
                operateFixed: true,
                buttons: ['view', 'delete'],
                headerContent: ['search', 'add', 'statistics'],
                myQuery: '我的查询',
