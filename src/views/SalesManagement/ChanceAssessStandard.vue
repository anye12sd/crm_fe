...
<script>
    ...
    const tableData = [
        { status: '', departmentName: 201, startDate: '中文', endDate: 'O', theme: '管理机构', telephone: '', Email: '', address: '', link: '/SalesManagement/ChanceAssessStandardDetail' },
        { status: '', departmentName: 120, startDate: '中文2', endDate: 'OA', theme: '总公司', telephone: '', Email: '', address: '', link: '/SalesManagement/ChanceAssessStandardDetail' },
        { status: '', departmentName: 430, startDate: '中文3', endDate: 'OAOA', theme: '名称1', telephone: '', Email: '', address: '', link: '/SalesManagement/ChanceAssessStandardDetail' },
        { status: '', departmentName: 404, startDate: '中文4', endDate: 'O', theme: '名称1', telephone: '', Email: '', address: '', link: '/SalesManagement/ChanceAssessStandardDetail' },
        { status: '', departmentName: 111, startDate: '中文5', endDate: 'OA', theme: '名称1', telephone: '', Email: '', address: '', link: '/SalesManagement/ChanceAssessStandardDetail' },
        { status: '', departmentName: 65, startDate: '中文6', endDate: 'OAOA', theme: '名称1', telephone: '', Email: '', address: '', link: '/SalesManagement/ChanceAssessStandardDetail' },
        { status: '', departmentName: 7, startDate: '中文7', endDate: 'A', theme: '名称1', telephone: '', Email: '', address: '', link: '/SalesManagement/ChanceAssessStandardDetail' }
    ];
    const columns = [
        {
            title: '状态',
    ...
    export default {
        ...
        data() {
            return {
                ...
                operateFixed: true,
                buttons: ['view'],
                headerContent: ['search', 'select', 'excel', 'statistics', 'add', 'displaylist'],
                myQuery: '我的查询',
