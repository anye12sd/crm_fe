...
<script>
    const tableData = [
        { sign: '', category: 201, theme: '中文', customerName: 'O', salesExpect: '管理机构', telephone: '', Email: '', address: '', link: '/SalesManagement/SalesChanceDetail' },
        { sign: '', category: 120, theme: '中文2', customerName: 'OA', salesExpect: '总公司', telephone: '', Email: '', address: '', link: '/SalesManagement/SalesChanceDetail' },
        { sign: '', category: 430, theme: '中文3', customerName: 'OAOA', salesExpect: '名称1', telephone: '', Email: '', address: '', link: '/SalesManagement/SalesChanceDetail' },
        { sign: '', category: 404, theme: '中文4', customerName: 'O', salesExpect: '名称1', telephone: '', Email: '', address: '', link: '/SalesManagement/SalesChanceDetail' },
        { sign: '', category: 111, theme: '中文5', customerName: 'OA', salesExpect: '名称1', telephone: '', Email: '', address: '', link: '/SalesManagement/SalesChanceDetail' },
        { sign: '', category: 65, theme: '中文6', customerName: 'OAOA', salesExpect: '名称1', telephone: '', Email: '', address: '', link: '/SalesManagement/SalesChanceDetail' },
        { sign: '', category: 7, theme: '中文7', customerName: 'A', salesExpect: '名称1', telephone: '', Email: '', address: '', link: '/SalesManagement/SalesChanceDetail' }
    ];
    const columns = [
        {
            title: '标志',
